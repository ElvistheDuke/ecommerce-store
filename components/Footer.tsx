...
function Footer() {
  return (
    <footer>
      <div className="w-full border-t flex flex-col items-center justify-center mt-20 bg-[var(--color-primary)] text-white">
        <div className="container flex flex-col items-center text-center md:text-start gap-4 md:flex-row justify-between py-10">
            ...
            <div className="flex items-center gap-2 mt-4">
              ...
              <div>
                <svg
                  ...
                  height="100"
                  viewBox="0 0 24 24"
                  className="fill-white h-8 w-8 cursor-pointer"
                >
          ...
          <div className="flex flex-col gap-4 flex-1">
            <p className="text-lg font-bold">
              Sign Up for Discount and Updates
            </p>
            <input
              type="text"
              ...
              name=""
              id=""
              className="bg-white text-black p-2 rounded-md w-full max-w-sm"
            />
        ...
        <p className="text-sm pb-4">© 2025 MyStore. All rights reserved.</p>
      </div>
    </footer>
  );
}
